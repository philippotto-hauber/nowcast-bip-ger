...
IF %switch_download_data%==1 (
    ...
    Rem Rscript --no-save --no-restore "./src/real time data/R/download_bbk_financial_data.R" "%DIR_REALTIMEDATA%/raw data"
    Rem Rscript --no-save --no-restore "./src/real time data/R/download_esi.R" "%DIR_REALTIMEDATA%/raw data"    
    Rem Rscript --no-save --no-restore "./src/real time data/R/download_ifo.R" "%DIR_REALTIMEDATA%/raw data"
    Rem Rscript --no-save --no-restore "./src/real time data/R/compile_rtd_lkw_maut_index.R" "%DIR_REALTIMEDATA%\raw data" "%DIR_REPO%"
    Rem Rscript --no-save --no-restore "./src/real time data/R/compile_rtd_gastgewerbe.R" "%DIR_REALTIMEDATA%\raw data" "%DIR_REPO%"
