function f_plotfanchart(dens,nametitle,dates)



[lh, ph] = fanChart_PH(1:size(dens,1), dens,'mean', [5 25 50 75 95]);

legend([lh;ph],'mean','50 %','90%','Location','best')
title(nametitle)
xtickangle(60)
ax = gca;
ax.XTick = 1:size(dens,1);
ax.XTickLabel = dates;
ax.XLim = [0 size(dens,1)+1] ; 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [lh, ph] = fanChart_PH(xvals, paths, centerType, prctiles, varargin)
...
lh = line(xvals, centerline, 'LineWidth', 2, 'Color', [0.8 0 0], 'LineStyle', '--', 'Parent', parent);
ph = flipud(ph);
