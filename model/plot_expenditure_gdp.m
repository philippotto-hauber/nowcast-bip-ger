function out = plot_expenditure_gdp(dir_root, year_nowcast, quarter_nowcast) 
    ...
    vars = {'privVerbrauch', 'Exporte'};
    str_titles = {'privater Verbrauch q/q', 'Export, q/q'};
    Nvars = length(vars);
    ...
    disp('Done plotting GDP expenditure side forecasts')
    out = [];
end
