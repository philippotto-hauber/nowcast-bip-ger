        ...
        for Nr = Nrs
            for Np = Nps
                for Nj = Njs
                    ...
                    f_docu(squeeze(results.nowcast.(var).new(1,:,modcounter)), ...
                           results.vintages, ...
                    ...
                    f_docu(squeeze(results.forecast.(var).new(1,:,modcounter)), ...
                           results.vintages, ...
                    ...
                    f_docu(mean(results.nowcast.(var).new(1,:,:),3), ...
                        results.vintages, ...
                        ew_pool_details, ...
                        Nr, ...
                        Np, ...
                        ...
                        threshold, ...
                        dir_nowcast) ; 
                    f_docuII(mean(results.nowcast.(var).new(1,:,:),3), ...
                            results.vintages, ...
                            ew_pool_details, ...
                            Nr, ...
                            Np, ...
                    ...
                    f_docu(mean(results.forecast.(var).new(1,:,:),3), ...
                        results.vintages, ...
                        ew_pool_details, ...
                        Nr, ...
                        Np, ...
                    ...
                    f_docuII(mean(results.forecast.(var).new(1,:,:),3), ...
                            results.vintages, ...
                            ew_pool_details, ...
                            Nr, ...
                            Np, ...
