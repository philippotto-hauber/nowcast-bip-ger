...
% group field is overwritten in f_load_ESIBCI with 'surveys'!
        ...
        'Current level of capacity utilization'  'ESI: industry' , 1 , 'q:A' , 1 , 0 , 'INDU.DE.TOT.13.QPS.Q' ; 
        % -------RETAIL-------------- %
        ...
        'Current level of capacity utilization' , 'ESI: services' , 1 , 'q:A' , 1 , 0 , 'SERV.DE.TOT.8.QPS.Q' ;     
        % -------CONSUMER-------------- %
